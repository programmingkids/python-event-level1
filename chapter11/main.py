import tkinter
import chapter11.player as player
import chapter11.data as data
import chapter11.fight as fight
...
# プレイヤ画像を読み込み
player = player.Player("レイナ", 40, 20, tkinter.PhotoImage(file="../images/chara02.png"), [13, 9])
